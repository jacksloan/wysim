...
- A line that is just a tabstring gets its name auto-detected (shown in gray; powered by [tonal](https://github.com/tonaljs/tonal)); explicit names always win. Toggle "Auto-name chords" off in the gear settings to leave them blank
